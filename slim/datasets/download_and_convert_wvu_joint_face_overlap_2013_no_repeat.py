...
def _get_filenames_and_classes(dataset_dir):
    ...
    """
    flower_root = os.path.join(dataset_dir, 'Joint_Face_Train_Data_2013_overlap_no_repeats')
    directories = []
    class_names = []
...
def _get_dataset_filename(dataset_dir, split_name, shard_id):
    output_filename = 'wvu_joint_face_overlap_2013_no_repeat_%s_%05d-of-%05d.tfrecord' % (
...
def run(dataset_dir):
  ...
  #  random.shuffle(photo_filenames)
    ...
    # _clean_up_temporary_files(dataset_dir)
    print('\nFinished converting the WVU Joint Face Overlap 2013 dataset!')
