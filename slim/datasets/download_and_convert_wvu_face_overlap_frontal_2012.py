...
def _get_filenames_and_classes(dataset_dir):
    ...
    """
    flower_root = os.path.join(dataset_dir, 'WVU_Train_Data_Overlap_12_Frontal_folders')
    directories = []
    class_names = []
...
def _get_dataset_filename(dataset_dir, split_name, shard_id):
    output_filename = 'wvu_face_overlap_frontal_2012_%s_%05d-of-%05d.tfrecord' % (
...
#    random.shuffle(photo_filenames)
    ...
    # _clean_up_temporary_files(dataset_dir)
    print('\nFinished converting the WVU Face Overlap Frontal 2012 dataset!')
