...
def _get_dataset_filename(dataset_dir, split_name, shard_id):
	output_filename = 'wvu_joint_iris_and_face_overlap_2013_no_repeat_%s_%05d-of-%05d.tfrecord' % (
...
def run(dataset_dir):
	...
	photo_filenames_iris, class_names_iris = _get_filenames_and_classes(dataset_dir,'/media/veerut/DATADISK/TensorFlow/Joint/Joint_Iris_Train_Data_2013_overlap_no_repeats')
	photo_filenames_face, class_names_face = _get_filenames_and_classes(dataset_dir,'/media/veerut/DATADISK/TensorFlow/Joint/Joint_Face_Train_Data_2013_overlap_no_repeats')
	...
	# _clean_up_temporary_files(dataset_dir)
	print('\nFinished converting the WVU Joint Iris Overlap 2013 dataset!')
