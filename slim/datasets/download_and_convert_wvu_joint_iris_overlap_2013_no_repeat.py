...
def _get_filenames_and_classes(dataset_dir):
    ...
    """
    flower_root = os.path.join(dataset_dir, 'Joint_Iris_Train_Data_2013_overlap_no_repeats')
    directories = []
    class_names = []
...
def _get_dataset_filename(dataset_dir, split_name, shard_id):
    output_filename = 'wvu_joint_iris_overlap_2013_no_repeat_%s_%05d-of-%05d.tfrecord' % (
