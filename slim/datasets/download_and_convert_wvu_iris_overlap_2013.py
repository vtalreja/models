...
def _get_filenames_and_classes(dataset_dir):
    ...
    """
    flower_root = os.path.join(dataset_dir, 'WVU_IRIS_2013_Train_Data_Overlap_folders_JPG')
    directories = []
    class_names = []
...
def _get_dataset_filename(dataset_dir, split_name, shard_id):
    output_filename = 'wvu_iris_overlap_2013_%s_%05d-of-%05d.tfrecord' % (
...
def run(dataset_dir):
    ...
    # _clean_up_temporary_files(dataset_dir)
    print('\nFinished converting the WVU Iris Overlap dataset!')
