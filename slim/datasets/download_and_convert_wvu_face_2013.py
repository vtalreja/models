...
def _get_filenames_and_classes(dataset_dir):
    ...
    """
    flower_root = os.path.join(dataset_dir, 'WVU_Training_Data_2013_aligned')
    directories = []
    class_names = []
...
def _get_dataset_filename(dataset_dir, split_name, shard_id):
    output_filename = 'wvu_face_2013_%s_%05d-of-%05d.tfrecord' % (
...
def run(dataset_dir):
    ...
    # _clean_up_temporary_files(dataset_dir)
    print('\nFinished converting the WVU Face dataset!')
