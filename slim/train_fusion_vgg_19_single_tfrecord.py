...
# This is the file for fine-tuning the joint layer for fully connected architecture using a joint tf record
...
tf.app.flags.DEFINE_string(
	'train_dir', '/media/veerut/full/TensorFlow/Joint/Joint_CheckPoints_2013_overlap_vgg_19_joint_tf_record_with_dropout_no_finetune_1024/',
...
tf.app.flags.DEFINE_string(
	'model_name_joint', 'vgg_19_joint_1024', 'The name of the architecture to train.')
...
tf.app.flags.DEFINE_string(
	'checkpoint_path_iris', '/media/veerut/full/TensorFlow/Iris/CHKPNTIRIS13/model.ckpt-34744',
...
tf.app.flags.DEFINE_string(
	'checkpoint_path_face', '/media/veerut/full/TensorFlow/Face/CHKPNTFACE13/model.ckpt-52389',
	'The path to a checkpoint from which to fine-tune.')
