...
tf.app.flags.DEFINE_string(
	'train_dir', '/media/veerut/DATADISK/TensorFlow/Joint/Joint_CheckPoints_2013_overlap_vgg_19_1_reader_2/',
...
tf.app.flags.DEFINE_string(
	'checkpoint_path_iris', '/media/veerut/DATADISK/TensorFlow/Iris/CHKPNTIRIS13c12/model.ckpt-4713',
...
tf.app.flags.DEFINE_string(
	'checkpoint_path_face', '/media/veerut/DATADISK/TensorFlow/Face/CHKPNTFACE13c12/model.ckpt-40000',
	'The path to a checkpoint from which to fine-tune.')
