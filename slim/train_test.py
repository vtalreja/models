...
tf.app.flags.DEFINE_string(
    'train_dir', '/media/veerut/DATADISK/TensorFlow/Face/CheckPoints_Train_Logs_no_mov',
...
tf.app.flags.DEFINE_string(
    'dataset_name', 'wvu_face_2013', 'The name of the dataset to load.')

tf.app.flags.DEFINE_string(
    'dataset_split_name', 'train', 'The name of the train/test split.')

tf.app.flags.DEFINE_string(
    'dataset_dir', '/media/veerut/DATADISK/TensorFlow/Face/WVU_Training_Data_2013_TFRecords', 'The directory where the dataset files are stored.')
...
tf.app.flags.DEFINE_string(
    'model_name', 'vgg_16_face', 'The name of the architecture to train.')
...
tf.app.flags.DEFINE_integer(
    'New_Height_Of_Image', 224, 'The Height of The Images in The Dataset. Default is 224')

tf.app.flags.DEFINE_integer(
    'New_Width_Of_Image', 224, 'The Width of The Images in the dataset.Default is 224')
...
tf.app.flags.DEFINE_string(
    'checkpoint_path', '/media/veerut/DATADISK/TensorFlow/Face/CASIA_checkpoints/model.ckpt-118680',
    'The path to a checkpoint from which to fine-tune.')

tf.app.flags.DEFINE_string(
    'checkpoint_exclude_scopes', 'vgg_19/conv3/conv3_4/biases,vgg_19/conv3/conv3_4/weights,vgg_19/conv4/conv4_4/biases,vgg_19/conv4/conv4_4/weights,vgg_19/conv5/conv5_4/biases,vgg_19/conv5/conv5_4/weights,vgg_19/fc8/biases,vgg_19/fc8/weights',
