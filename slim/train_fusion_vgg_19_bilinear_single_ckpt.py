...
tf.app.flags.DEFINE_string(
	'train_dir', '/media/veerut/full/TensorFlow/Joint/Joint_CheckPoints_2013_overlap_vgg_19_joint_tf_record_no_bn_ft_lastlay_full_bilinear/',
...
tf.app.flags.DEFINE_string(
	'model_name_joint', 'vgg_19_joint_bilinear', 'The name of the architecture to train.')
...
tf.app.flags.DEFINE_string(
	'checkpoint_path', '/media/veerut/full/TensorFlow/Joint/Joint_CheckPoints_2013_overlap_vgg_19_joint_tf_record_no_bn_ft_lstlay_bilinear/model.ckpt-47587',
	'The path to a checkpoint from which to fine-tune.')
