...
# This is the file to fine-tune the entire network end-to-end using a single checkpoint after the last joint layer has been tuned
...
tf.app.flags.DEFINE_string(
	'train_dir', '/media/veerut/full/TensorFlow/Joint/Joint_CheckPoints_2013_overlap_vgg_19_joint_tf_record_with_dropout_no_finetune_fc_full',
...
tf.app.flags.DEFINE_string(
	'checkpoint_path_iris', '/media/veerut/full/TensorFlow/Iris/CheckPoints_Train_Logs_bilinear_iris_2013_overlap_30_ep/model.ckpt-10669',
...
tf.app.flags.DEFINE_string(
	'checkpoint_path_face', '/media/veerut/full/TensorFlow/Face/CheckPoints_Train_Logs_bilinear_face_2013_overlap_30_ep/model.ckpt-70000',
	'The path to a checkpoint from which to fine-tune.')
...
tf.app.flags.DEFINE_string(
	'checkpoint_path', '/media/veerut/full/TensorFlow/Joint/Joint_CheckPoints_2013_overlap_vgg_19_joint_tf_record_with_dropout_no_finetune/model.ckpt-40976',
	'The path to a checkpoint from which to fine-tune.')

tf.app.flags.DEFINE_string(
	'checkpoint_exclude_scopes', 'vgg_joint/fc8_joint/weights,vgg_joint/fc8_joint/biases',
	'Comma-separated list of scopes of variables to exclude when restoring '
	'from a checkpoint.')
