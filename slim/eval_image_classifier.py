...
tf.app.flags.DEFINE_string(
	'checkpoint_path', '/media/veerut/DATADISK/TensorFlow/Iris/Checkpoint_Copy_WVU_2013',
	'The directory where the model was written to or an absolute path to a '
	'checkpoint file.')

tf.app.flags.DEFINE_string(
	'eval_dir', '/media/veerut/DATADISK/TensorFlow/Iris/Checkpoint_Copy_WVU_2013_eval', 'Directory where the results are saved to.')
...
tf.app.flags.DEFINE_string(
	'dataset_name', 'wvu_iris_2013', 'The name of the dataset to load.')

tf.app.flags.DEFINE_string(
	'dataset_split_name', 'validation', 'The name of the train/test split.')

tf.app.flags.DEFINE_string(
	'dataset_dir', '/media/veerut/DATADISK/TensorFlow/Iris/WVU_IRIS_2013_Train_Data_TFRecords', 'The directory where the dataset files are stored.')
...
tf.app.flags.DEFINE_string(
	'model_name', 'vgg_16_iris', 'The name of the architecture to evaluate.')
