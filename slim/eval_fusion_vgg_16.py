...
tf.app.flags.DEFINE_string(
	'checkpoint_path', '/media/veerut/DATADISK/TensorFlow/Joint/Joint_CheckPoints_2013_overlap_tr_joint_all_train',
	'The directory where the model was written to or an absolute path to a '
	'checkpoint file.')

tf.app.flags.DEFINE_string(
	'eval_dir', '/media/veerut/DATADISK/TensorFlow/Joint/Joint_CheckPoints_2013_overlap_tr_joint_all_train_eval', 'Directory where the results are saved to.')
...
tf.app.flags.DEFINE_string(
	'dataset_name_face', 'wvu_joint_face_overlap_2012_no_repeat', 'The name of the dataset to load.')

tf.app.flags.DEFINE_string(
	'dataset_name_iris', 'wvu_joint_iris_overlap_2012_no_repeat', 'The name of the dataset to load.')

tf.app.flags.DEFINE_string(
	'dataset_split_name', 'train', 'The name of the train/test split.')

tf.app.flags.DEFINE_string(
	'dataset_dir_face', '/media/veerut/DATADISK/TensorFlow/Joint/Joint_Face_Train_Data_2012_overlap_no_repeats_TfRecords', 'The directory where the dataset files are stored.')

tf.app.flags.DEFINE_string(
	'dataset_dir_iris', '/media/veerut/DATADISK/TensorFlow/Joint/Joint_Iris_Train_Data_2012_overlap_no_repeats_TfRecords', 'The directory where the dataset files are stored.')
...
tf.app.flags.DEFINE_string(
	'model_name_face', 'vgg_16_face', 'The name of the architecture to be used for preprocessing.')

tf.app.flags.DEFINE_string(
	'model_name_iris', 'vgg_16_iris', 'The name of the architecture to be used for preprocessing.')

tf.app.flags.DEFINE_string(
	'model_name_joint', 'vgg_joint', 'The name of the architecture to be used for preprocessing.')
...
def main(_):
  ...
  with tf.Graph().as_default():
	...
	one_hot_labels = slim.one_hot_encoding(labels_face,  dataset_face.num_classes - FLAGS.labels_offset)
