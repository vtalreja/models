...
tf.app.flags.DEFINE_string(
    'train_dir', '/media/veerut/full/TensorFlow/Iris/CheckPoints_Train_Logs_gap_iris_2013_overlap_30_ep_fine_tune',
...
tf.app.flags.DEFINE_string(
    'dataset_name', 'wvu_iris_overlap_2013', 'The name of the dataset to load.')

tf.app.flags.DEFINE_string(
    'dataset_split_name', 'train', 'The name of the train/test split.')

tf.app.flags.DEFINE_string(
    'dataset_dir', '/media/veerut/full/TensorFlow/Iris/WVU_IRIS_2013_Train_Data_Overlap_TFRecords', 'The directory where the dataset files are stored.')
...
tf.app.flags.DEFINE_string(
    'model_name', 'vgg_19_iris_gap', 'The name of the architecture to train.')
...
tf.app.flags.DEFINE_string(
    'checkpoint_path', '/media/veerut/full/TensorFlow/Iris/CHKPNTIRIS13/model.ckpt-34744',
    'The path to a checkpoint from which to fine-tune.')

tf.app.flags.DEFINE_string(
    'checkpoint_exclude_scopes', 'vgg_19/fc6/biases,vgg_19/fc6/weights,vgg_19/fc6/BatchNorm,vgg_19/fc7/biases,vgg_19/fc7/weights,vgg_19/fc7/BatchNorm,vgg_19/fc8/biases,vgg_19/fc8/weights',
