...
tf.app.flags.DEFINE_string(
	'checkpoint_path', '/media/veerut/DATADISK/TensorFlow/Joint/Joint_CheckPoints_2013_overlap_vgg_19_tr_on_overlap',
	'The directory where the model was written to or an absolute path to a '
	'checkpoint file.')

tf.app.flags.DEFINE_string(
	'eval_dir', '/media/veerut/DATADISK/TensorFlow/Joint/Joint_CheckPoints_2013_overlap_vgg_19_eval', 'Directory where the results are saved to.')
...
tf.app.flags.DEFINE_string(
	'model_name_joint', 'vgg_19_joint', 'The name of the architecture to be used for preprocessing.')
