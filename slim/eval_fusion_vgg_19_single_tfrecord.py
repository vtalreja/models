...
tf.app.flags.DEFINE_string(
	'checkpoint_path', '/media/veerut/full/TensorFlow/Joint/Joint_CheckPoints_2013_overlap_vgg_19_joint_tf_record_with_dropout_no_finetune_fc_full',
	'The directory where the model was written to or an absolute path to a '
	'checkpoint file.')

tf.app.flags.DEFINE_string(
	'eval_dir', '/media/veerut/full/TensorFlow/Joint/Joint_CheckPoints_2013_overlap_vgg_19_joint_tf_record_with_dropout_no_finetune_fc_full_eval', 'Directory where the results are saved to.')
