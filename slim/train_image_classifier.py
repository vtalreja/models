...
tf.app.flags.DEFINE_integer(
    'New_Height_Of_Image', None, 'The Height of The Images in The Dataset. Default is 224')

tf.app.flags.DEFINE_integer(
    'New_Width_Of_Image', None, 'The Width of The Images in the dataset.Default is 224')
