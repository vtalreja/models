...
tf.app.flags.DEFINE_string(
	'train_dir', '/media/veerut/DATADISK/TensorFlow/Joint/Joint_CheckPoints_2013_overlap_tr_joint_all_train/',
...
tf.app.flags.DEFINE_string(
	'dataset_dir_iris', '/media/veerut/DATADISK/TensorFlow/Joint/Joint_Iris_Train_Data_2013_overlap_no_repeats_1_TfRecords', 'The directory where the dataset files are stored.')
...
tf.app.flags.DEFINE_string(
	'dataset_dir_face', '/media/veerut/DATADISK/TensorFlow/Joint/Joint_Face_Train_Data_2013_overlap_no_repeats_1_TfRecords', 'The directory where the dataset files are stored.')
...
tf.app.flags.DEFINE_string(
	'model_name_joint', 'vgg_joint', 'The name of the architecture to train.')
...
tf.app.flags.DEFINE_integer('max_number_of_steps', 25000,
...
tf.app.flags.DEFINE_string(
	'checkpoint_path_iris', '/media/veerut/DATADISK/TensorFlow/Iris/Checkpoint_Copy_WVU_2013',
	'The path to a checkpoint from which to fine-tune.')

tf.app.flags.DEFINE_string(
	'checkpoint_exclude_scopes_iris', 'vgg_16/fc8/weights,vgg_16/fc8/biases',
...
tf.app.flags.DEFINE_string(
	'checkpoint_path_face', '/media/veerut/DATADISK/TensorFlow/Face/CheckPoints_Train_Logs_no_mov',
	'The path to a checkpoint from which to fine-tune.')

tf.app.flags.DEFINE_string(
	'checkpoint_exclude_scopes_face', 'vgg_19/fc8/weights,vgg_19/fc8/biases',
	'Comma-separated list of scopes of variables to exclude when restoring '
	'from a checkpoint.')
...
def _get_init_op():
	...
	for var in slim.get_model_variables('vgg_19'):
		excluded = False
